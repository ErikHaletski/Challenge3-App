...
enum class PermQuests(val quest: Quest, val reqLvl: Int) {
    ...
    M_PUSHUPS_01(Quest("s1", "12 Pushups", "Mach 12 Liegestütze", 60, Attributes.ARMSTRENGTH.name, 2, QuestType.NORMAL, 0), 1),
    S_BEINE_01(Quest("s2", "beine", "mach beine", 30, Attributes.LEGSTRENGTH.name, 2, QuestType.NORMAL, 0), 1),
    S_ENDURANCE_01(Quest("s3", "ausdauer", "mach ausdauer", 40, Attributes.ENDURANCE.name, 3, QuestType.NORMAL, 0), 1)
}